TEXTS = {
    ...
    # ===== Passkey Management =====
    'btn_passkey_manage': '🔑 Passkey Manage',
    'passkey_title': '🔑 Passkey Management',
    'passkey_feature1': '· 🔍 Detect if account has Passkeys bound',
    'passkey_feature2': '· 🗑️ Auto delete all bound Passkeys',
    'passkey_feature3': '· Prevent upstream from recovering account via Passkey',
    'passkey_what_is': '📋 What is Passkey?',
    'passkey_what_desc1': '· Biometric login credential bound to device',
    'passkey_what_desc2': '· Can replace SMS code to login Telegram directly',
    'passkey_what_desc3': '· Upstream can re-login via device Passkey',
    'passkey_upload_prompt': '📤 Upload ZIP file to start (Session or TData format)',
    'passkey_scan_complete': '✅ Scan complete',
    'passkey_found_accounts': '📊 Found <b>{count}</b> accounts ({type})',
    'passkey_operation_desc': '🔑 Will execute:',
    'passkey_op1': '  1. Detect Passkey status for each account',
    'passkey_op2': '  2. Auto delete all bound Passkeys',
    'passkey_op3': '  3. Package results by category',
    'passkey_warning': '⚠️ Cannot recover account via Passkey after deletion',
    'passkey_btn_execute': '🚀 Confirm Execute',
    'passkey_processing': '🔑 Processing Passkeys...',
    'passkey_progress_bar': '[{bar}] {pct}%',
    'passkey_stat_no_passkey': '🔓 No Passkey: {count}',
    'passkey_stat_deleted': '✅ Deleted: {count}',
    'passkey_stat_failed': '❌ Failed: {count}',
    'passkey_complete': '🎉 Passkey processing complete!',
    'passkey_result_no_passkey': '  🔓 No Passkey (clean): <b>{count}</b>',
    'passkey_result_deleted': '  ✅ Passkey deleted: <b>{count}</b>',
    'passkey_result_deleted_count': '     Total <b>{count}</b> passkeys removed',
    'passkey_result_failed': '  ❌ Failed: <b>{count}</b>',
    'passkey_elapsed': '⏱️ Total time: {seconds}s',
    'passkey_packing': '📦 Packing result files...',
    'passkey_send_failed': '⚠️ Failed to send result files, check logs',
    'zip_passkey_no_passkey': 'NoPasskey_Clean_{count}',
    'zip_passkey_deleted': 'PasskeyDeleted_{count}',
    'zip_passkey_failed': 'PasskeyFailed_{count}',
    'report_passkey_title': 'Passkey Processing Report',
    'report_passkey_generated': 'Generated: {time}',
    'report_passkey_total': 'Total accounts: {count}',
    'report_passkey_account': 'Account: {account}',
    'report_passkey_had_passkey': '  Passkeys found: {count}',
    'report_passkey_deleted': '  Deleted: {count}',
    'report_passkey_no_passkey': '  No Passkey',
    'report_passkey_error': '  Error: {error}',
    # Passkey sub-menu (detect/delete vs create)
    'passkey_submenu_title': '🔑 Passkey Management',
    ...
    'passkey_create_desc2': '· Binds a new Passkey credential to the account',
    'passkey_create_desc3': '· Supports batch creation for multiple accounts',
    'passkey_create_upload_prompt': '📤 Upload ZIP file to start (Session or TData format)',
    'passkey_create_scan_complete': '✅ Scan complete',
    'passkey_create_found_accounts': '📊 Found <b>{count}</b> accounts ({type})',
    'passkey_create_operation_desc': '➕ Will execute:',
    'passkey_create_op1': '  1. Connect to each account',
    'passkey_create_op2': '  2. Generate FIDO2 credential via software',
    'passkey_create_op3': '  3. Submit registration and bind new Passkey',
    'passkey_create_btn_execute': '🚀 Confirm Create',
    'passkey_create_processing': '➕ Creating Passkeys...',
    'passkey_create_stat_created': '✅ Created: {count}',
    'passkey_create_stat_failed': '❌ Failed: {count}',
    'passkey_create_complete': '🎉 Passkey creation complete!',
    'passkey_create_result_created': '  ✅ Created: <b>{count}</b>',
    'passkey_create_result_failed': '  ❌ Failed: <b>{count}</b>',
